...
<div class="wbcom-tab-content">
	<div class="wbcom-welcome-main-wrapper">
		...
		<p class="wbcom-welcome-description">
			<?php esc_html_e( 'Hashtags are a powerful tool for increasing content discoverability and audience engagement on social media platforms. BuddyPress Hashtag lets members create custom hashtags for campaigns or events, like #NewProductLaunch.', 'buddypress-hashtags' ); ?>
		</p>
			...
			<div class="wbcom-welcome-support-info">
				...
				<div class="wbcom-support-info-wrap">
					...
					<div class="wbcom-support-info-widgets">
						...
						<a href="<?php echo esc_url( 'https://wbcomdesigns.com/submit-review/ ' ); ?>" class="button button-primary button-welcome-support" target="_blank"><?php esc_html_e( 'Send Feedback', 'buddypress-hashtags' ); ?></a>
					</div>
					</div>
				</div>
			</div>
