...
class MEC_factory extends MEC_base
{
    ...
    {
        $settings = '<a href="'.esc_url($this->main->add_qs_vars(array('page'=>'MEC-settings'), $this->main->URL('admin').'admin.php')).'">'._x('Settings', 'plugin link', 'mec').'</a>';
    ...
    function mecShowUpgradeNotification($currentPluginMetadata, $newPluginMetadata){
        ...
        ?>
            <div class="mec-update-warning" style="margin-bottom: 5px; max-width: 1000px;">
                ...
                <a href="https://webnus.net/dox/modern-events-calendar/manual-update/" target="_blank"><?php echo esc_html__( 'How to manually update', 'mec' ); ?></a>
            </div>
        <?php
