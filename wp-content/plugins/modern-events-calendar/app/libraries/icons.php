...
class MEC_icons
{
    ...
    public function display($key)
    {
        ...
        $custom = isset($this->icons[$key]) && trim($this->icons[$key]) ? '<img src="'.esc_url_raw($this->icons[$key]).'">' : '';
            ...
            <div class="mec-col-12 mec-image-picker-page">
                ...
                <div class="mec-icon mec-image-picker-wrapper" id="mec-icons-<?php echo esc_attr($key); ?>">
                    ...
                    <div class="mec-icon-uploader">
                        <button type="button" class="button button-secondary mec-image-picker-upload" id="mec_icons_<?php echo esc_attr($key); ?>"><?php esc_html_e('Upload', 'mec'); ?></button>
                        <button class="button button-secondary mec-image-picker-remove w-hidden"><?php esc_html_e('Remove', 'mec'); ?></button>
