...
<div id="<?php echo esc_attr( $group_id ) ?>_notification_section" class="mec-options-fields <?php echo esc_attr( $class ) ?>">
    ...
    <div id="mec_notification_<?php echo esc_attr( $group_id );  ?>_notification_container_toggle" class="<?php if(isset($options) and isset($options['status']) and !$options['status']) echo 'mec-util-hidden'; ?>">
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label for="mec_notifications_<?php echo esc_attr( $group_id );  ?>_notification_subject"><?php esc_html_e('Email Subject', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label for="mec_notifications_<?php echo esc_attr( $group_id );  ?>_notification_receiver_users"><?php esc_html_e('Receiver Users', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
                <?php
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label for="mec_notifications_<?php echo esc_attr( $group_id );  ?>_notification_receiver_roles"><?php esc_html_e('Receiver Roles', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
                <?php
        ...
        <div class="mec-form-row">
            <div class="mec-col-3">
                <label for="mec_notifications_<?php echo esc_attr( $group_id );  ?>_notification_recipients"><?php esc_html_e('Custom Recipients', 'mec'); ?></label>
            </div>
            <div class="mec-col-9">
                ...
                <span class="mec-tooltip">
                    <div class="box left">
                        ...
                        <div class="content"><p><?php esc_attr_e('Insert the comma separated email addresses for multiple recipients.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/notifications/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                    </div>
                    <i title="" class="dashicons-before dashicons-editor-help"></i>
                </span>
            </div>
