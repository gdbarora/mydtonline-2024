...
class SettingsForm extends Singleton {
	...
	public function get_element_fields( $type = 'reg' ) {
		...
		$elements = array(
				'first_name'      => array(
					'required' => true,
					'text'     => esc_html__( 'MEC First Name', 'mec' ),
					'class'    => 'red',
				),
				'last_name'      => array(
					'required' => true,
					'text'     => esc_html__( 'MEC Last Name', 'mec' ),
					'class'    => 'red',
				),
				'mec_email' => array(
						'required' => true,
						'text'     => esc_html__( 'MEC Email', 'mec' ),
						'class'    => 'red',
				),
				'text'      => array(
						'required' => false,
						'text'     => esc_html__( 'Text', 'mec' ),
						'class'    => '',
				),
				'email'     => array(
						'required' => false,
						'text'     => esc_html__( 'Email', 'mec' ),
						'class'    => '',
				),
				'date'      => array(
						'required' => false,
						'text'     => esc_html__( 'Date', 'mec' ),
						'class'    => '',
				),
				'tel'       => array(
						'required' => false,
						'text'     => esc_html__( 'Tel', 'mec' ),
						'class'    => '',
				),
				'file'      => array(
						'required' => false,
						'text'     => esc_html__( 'File', 'mec' ),
						'class'    => '',
				),
				'textarea'  => array(
						'required' => false,
						'text'     => esc_html__( 'Textarea', 'mec' ),
						'class'    => '',
				),
				'checkbox'  => array(
						'required' => false,
						'text'     => esc_html__( 'Checkboxes', 'mec' ),
						'class'    => '',
				),
				'radio'     => array(
						'required' => false,
						'text'     => esc_html__( 'Radio Buttons', 'mec' ),
						'class'    => '',
				),
				'select'    => array(
						'required' => false,
						'text'     => esc_html__( 'Dropdown', 'mec' ),
						'class'    => '',
				),
				'agreement' => array(
						'required' => false,
						'text'     => esc_html__( 'Agreement', 'mec' ),
						'class'    => '',
				),
				'p'         => array(
						'required' => false,
						'text'     => esc_html__( 'Paragraph', 'mec' ),
						'class'    => '',
				),
		);
