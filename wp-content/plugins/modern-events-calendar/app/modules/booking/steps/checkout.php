...
<div id="mec_book_payment_form" class="mec-booking-form-container mec-wrap-checkout row">
    ...
    <?php else: ?>
        <h4><?php esc_html_e('Checkout', 'mec'); ?></h4>
    <?php endif; ?>
    ...
    <div class="mec-booking-checkout-coupon-total-wrapper">
            ...
            <div class="mec-book-form-coupon">
                <form id="mec_book_form_coupon<?php echo esc_attr($uniqueid); ?>" onsubmit="mec_book_apply_coupon<?php echo esc_attr($uniqueid); ?>(); return false;">
                    <span class="mec-booking-coupon-field-wrapper">
                        ...
                        <input type="text" name="coupon" title="<?php esc_attr_e('Discount Code', 'mec'); ?>" placeholder="<?php esc_attr_e('Discount Coupon', 'mec'); ?>" />
                    </span>
                    ...
                    <button type="submit"><?php esc_html_e('Apply', 'mec'); ?></button>
                </form>
        ...
        <div class="mec-booking-checkout-total-wrapper">
            <ul>
                <?php if(isset($this->settings['coupons_status']) and $this->settings['coupons_status']): ?>
                <li>
                    <span class="mec-book-price-label"><?php esc_html_e('Discount', 'mec'); ?></span>
                ...
                <?php endif; ?>
                <li>
                    <span class="mec-book-price-label"><?php esc_html_e('Total Price', 'mec'); ?></span>
                ...
                <li>
                    <span class="mec-book-price-label"><?php esc_html_e('Payable', 'mec'); ?></span>
    ...
    <div class="mec-book-form-gateways">
        <h3 class="mec-book-form-gateways-title"><?php esc_html_e('Select Payment Method', 'mec');?></h3>
    ...
    <p class="mec-ssl-protection-message">
        <?php echo $this->main->svg('form/lock-icon').' '.esc_html__('Your transaction is secured with SSL encryption.', 'mec'); ?>
    </p>
    <?php endif; ?>
    ...
    <form id="mec_book_form_free_booking<?php echo esc_attr($uniqueid); ?>" class="<?php echo $free_booking ? '' : 'mec-util-hidden'; ?> mec-click-next" onsubmit="mec_book_free<?php echo esc_attr($uniqueid); ?>(); return false;">
        <div class="mec-form-row">
            ...
            <div class="mec-click-pay">
                <button class="mec-book-form-next-button mec-book-form-pay-button" type="submit"><?php echo sprintf(esc_html__('Free %s', 'mec'), $this->main->m('booking', esc_html__('Booking', 'mec'))); ?></button>
            </div>
        </div>
    </form>

    <div class="mec-book-form-btn-wrap">
        <button id="mec-book-form-back-btn-step-3" class="mec-book-form-back-button" type="button" onclick="mec_book_form_back_btn_click(this);"><?php echo $this->main->svg('form/back-icon').' '.esc_html__('Back', 'mec'); ?></button>
    </div>
