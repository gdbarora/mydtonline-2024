...
class MEC_feature_organizers extends MEC_base
{
    ...
    ?>
        ...
        <tr class="form-field">
            <th scope="row">
                <label for="mec_url"><?php esc_html_e('Page URL', 'mec'); ?></label>
            </th>
            <td>
                <input type="url" placeholder="<?php esc_attr_e('Use this field to link organizer to other user profile pages', 'mec'); ?>" name="url" id="mec_url" value="<?php echo esc_attr($url); ?>" />
            </td>
        </tr>
        <tr class="form-field">
            <th scope="row">
                <label for="mec_page_label"><?php esc_html_e('Page Label', 'mec'); ?></label>
            </th>
            <td>
                <input type="text" placeholder="<?php esc_attr_e('Site name or any text', 'mec'); ?>" name="page_label" id="mec_page_label" value="<?php echo esc_attr($page_label); ?>" />
            </td>
        </tr>
        <tr class="form-field">
            <th scope="row">
    ...
    ?>
        ...
        <div class="form-field">
            <label for="mec_url"><?php esc_html_e('Page URL', 'mec'); ?></label>
            <input type="url" name="url" placeholder="<?php esc_attr_e('Use this field to link organizer to other user profile pages', 'mec'); ?>" id="mec_url" value="" />
        </div>
        <div class="form-field">
            <label for="mec_page_label"><?php esc_html_e('Page Label', 'mec'); ?></label>
            <input type="text" name="page_label" placeholder="<?php esc_attr_e('Site name or any text', 'mec'); ?>" id="mec_page_label" value="" />
        </div>
        <div class="form-field">
            <label for="mec_facebook"><?php esc_html_e('Facebook Page', 'mec'); ?></label>
