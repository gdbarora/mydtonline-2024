...
class MEC_feature_events extends MEC_base
{
    ...
    public function edit_category_fields($term)
    {
        ...
        <tr class="form-field">
            ...
            <td>
                ...
                <button type="button" class="mec_upload_image_button button" id="mec_thumbnail_button"><?php echo esc_html__('Upload/Add image', 'mec'); ?></button>
                <button type="button" class="mec_remove_image_button button <?php echo (!trim($fallback_image) ? 'mec-util-hidden' : ''); ?>"><?php echo esc_html__('Remove image', 'mec'); ?></button>
            </td>
        </tr>
        <?php endif; ?>
        <?php
    ...
    {
        // Event Details
        add_meta_box('mec_metabox_details', esc_html__('Event Details', 'mec'), array($this, 'meta_box_details'), $this->main->get_main_post_type(), 'normal', 'high');
        ...
        {
            add_meta_box('mec_metabox_visibility', esc_html__('Visibility', 'mec'), array($this, 'meta_box_visibility'), $this->main->get_main_post_type(), 'side');
        }

        // Gallery
        if(isset($this->settings['event_gallery_status']) && $this->settings['event_gallery_status'])
        {
            add_meta_box('mec_metabox_gallery', esc_html__('Gallery', 'mec'), array($this, 'meta_box_event_gallery'), $this->main->get_main_post_type(), 'side', 'low');
        }

        // Show Booking meta box only if booking module is enabled
        if($this->getPRO() and isset($this->settings['booking_status']) and $this->settings['booking_status'])
        {
            add_meta_box('mec_metabox_booking', esc_html__('Booking', 'mec'), array($this, 'meta_box_booking'), $this->main->get_main_post_type(), 'normal', 'high');
        }
    }
    ...
    public function meta_box_visibility($post)
    {
        ...
        <div class="mec-metabox-visibility">
            <?php if(!isset($this->settings['event_visibility_status']) or (isset($this->settings['event_visibility_status']) and $this->settings['event_visibility_status'])): ?>
                <label class="post-attributes-label"><?php esc_html_e('Visibility', 'mec'); ?></label class="post-attributes-label">
        ...
        <div class="mec-meta-box-fields" id="mec-date-time">
            ...
            <?php if(trim($fes_guest_email) and trim($fes_guest_name)): ?>
                <div class="mec-guest-data">
                    ...
                    <p><strong><?php esc_html_e('Name', 'mec'); ?>:</strong> <?php echo esc_html($fes_guest_name); ?></p>
                    <p><strong><?php esc_html_e('Email', 'mec'); ?>:</strong> <?php echo esc_html($fes_guest_email); ?></p>
                </div>
            <?php endif; ?>
            <?php if(($note_visibility and trim($note)) || (trim($fes_guest_email) and trim($fes_guest_name))): ?>
                </div>
            ...
            <div id="mec_meta_box_date_form" class="mec-event-tab-content">
                ...
                <div class="mec-basvanced-basic">
                    ...
                    <div class="mec-form-row">
                        <div class="mec-col-4">
                            <input type="text" name="mec[date][start][date]" id="mec_start_date" data-end="#mec_end_date" value="<?php echo esc_attr($this->main->standardize_format($start_date, $datepicker_format)); ?>" placeholder="<?php esc_html_e('Start Date', 'mec'); ?>" autocomplete="off"/>
                        </div>
                    ...
                    <div class="mec-form-row">
                        <div class="mec-col-4">
                            <input type="text" name="mec[date][end][date]" id="mec_end_date" data-start="#mec_start_date" value="<?php echo esc_attr($this->main->standardize_format($end_date, $datepicker_format)); ?>" placeholder="<?php esc_html_e('End Date', 'mec'); ?>" autocomplete="off"/>
                        </div>
                        <div class="mec-col-6 mec-time-picker <?php echo ($allday == 1) ? 'mec-util-hidden' : ''; ?>">
                            <?php $this->main->timepicker(array(
                                'method' => $this->settings['time_format'] ?? 12,
                                ...
                                <div class="box top">
                                    ...
                                    <div class="content">
                                        <p><?php esc_attr_e('It appears next to the event time on the Single Event Page. You can enter notes such as the timezone name in this field.', 'mec'); ?>
                                            <a href="https://webnus.net/dox/modern-events-calendar/add-event/#Date_and_Time" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a>
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="mec-form-row" id="mec_exceptions_in_days_container">
                        <div class="mec-form-row">
                            <div class="mec-col-12">
                                <div class="mec-form-row mec-in-days-add-mode" id="mec-in-days-form">
                                    ...
                                    <div class="mec-col-3">
                                        <button class="button" type="button" id="mec_add_in_days" data-allday="<?php echo esc_attr($allday); ?>"><?php esc_html_e('Add', 'mec'); ?></button>
                                        <button class="button" type="button" id="mec_edit_in_days" data-allday="<?php echo esc_attr($allday); ?>"><?php esc_html_e('Update', 'mec'); ?></button>
                                        <button class="button" type="button" id="mec_cancel_in_days"><?php esc_html_e('Cancel', 'mec'); ?></button>
                                        <span class="mec-tooltip">
                                            <div class="box top">
                                                ...
                                                <div class="content">
                                                    <p>
                                                        ...
                                                        <a href="https://webnus.net/dox/modern-events-calendar/add-event/#Repeat_Methods" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a>
                                                    </p>
                                                </div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                        ...
                        <div class="mec-form-row mec-certain-day" id="mec_in_days">
                            <?php $i = 1; foreach($in_days as $in_day): ?>
                                ...
                                <div class="mec-form-row" id="mec_in_days_row<?php echo esc_attr($i); ?>">
                                    ...
                                    <span class="mec-in-days-day" onclick="mec_in_days_edit(<?php echo esc_attr($i); ?>);" title="<?php echo esc_attr__('Click to edit', 'mec'); ?>"><?php echo MEC_kses::element($in_day_label); ?></span>
                        ...
                        <div class="mec-util-hidden" id="mec_new_in_days_raw">
                            <div class="mec-form-row" id="mec_in_days_row:i:">
                                ...
                                <span class="mec-in-days-day" onclick="mec_in_days_edit(:i:);" title="<?php echo esc_attr__('Click to edit', 'mec'); ?>">:label:</span>
								...
								<div class="box top">
									...
									<div class="content">
                                        <p><?php esc_attr_e('The event repeats will stop after certain number of occurences. For example if you set this option 10, the event will have 10 occurrences.', 'mec'); ?>
                                            <a href="https://webnus.net/dox/modern-events-calendar/add-event/#End_Repeat" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a>
                                        </p>
                                    </div>
								</div>
								<i title="" class="dashicons-before dashicons-editor-help"></i>
    ...
    public function meta_box_cost($post)
    {
        ...
        <div class="mec-meta-box-fields mec-event-tab-content" id="mec-cost">
            ...
            <div class="mec-basvanced-basic">
                ...
                <div id="mec_meta_box_cost_form" class="<?php echo ($cost_auto_calculate ? 'mec-util-hidden' : ''); ?>">
                    <div class="mec-form-row">
                        ...
                        <?php else: ?>
                            <input type="<?php echo ($type === 'alphabetic' ? 'text' : 'number'); ?>" <?php echo ($type === 'numeric' ? 'min="0" step="any"' : ''); ?> class="mec-col-3" name="mec[cost]" id="mec_cost" value="<?php echo esc_attr($cost); ?>" title="<?php esc_html_e('Cost', 'mec'); ?>" placeholder="<?php esc_html_e('Cost', 'mec'); ?>"/>
                        <?php endif; ?>
                    </div>
                </div>
                <?php if($this->getPRO()): ?>
            ...
            <div class="mec-basvanced-advanced w-hidden">
                            ...
                            <div class="box left">
                                ...
                                <div class="content">
                                    <p><?php esc_attr_e("Default value will be \"currency\" if you leave it empty.", 'mec'); ?>
                                        <a href="https://webnus.net/dox/modern-events-calendar/add-event/#Cost" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a>
                                    </p>
                                </div>
                            </div>
                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                ...
                <div class="mec-form-row">
                    <label class="mec-col-3" for="mec_currency_decimals"><?php esc_html_e('Decimals', 'mec'); ?></label>
                    <div class="mec-col-4">
        ...
        <div class="mec-meta-box-fields mec-event-tab-content mec-fes-exceptional-days" id="mec-exceptional-days">
            ...
            <div id="mec_meta_box_exceptions_form">
                <div id="mec_exceptions_not_in_days_container">
                    <div class="mec-title">
                        <span class="mec-dashicons dashicons dashicons-calendar-alt"></span>
                        <label for="mec_exceptions_not_in_days_date"><?php esc_html_e('Exclude certain days', 'mec'); ?></label>
                    </div>
                    <?php
    ...
    public function meta_box_event_gallery($post)
    {
        ...
        <div id="mec-event-gallery">
            <div id="mec_meta_box_event_gallery_options">
                <?php if(current_user_can('upload_files')): ?>
                <a href="#" type="button" id="mec_event_gallery_image_uploader"><?php esc_html_e('Add event gallery images', 'mec'); ?></a>
                <?php else: ?>
                <a href="#" type="file" id="mec_event_gallery_image_uploader" multiple><?php esc_html_e('Add event gallery images', 'mec'); ?></a>
                <?php endif; ?>
					...
					<div class="box top">
						...
						<div class="content">
                            <p><?php esc_attr_e('The value of this option will be replaced by the single event page link on shortcodes. Insert full link including http(s):// - Also, if you use an advertising URL, you can use the URL Shortener.', 'mec'); ?>
                                <a href="https://bit.ly/" target="_blank"><?php esc_html_e('URL Shortener', 'mec'); ?></a>
                            </p>
                        </div>
					</div>
					<i title="" class="dashicons-before dashicons-editor-help"></i>
					...
					<div class="box top">
						...
						<div class="content">
                            <p><?php esc_attr_e('This link will appear on the single event page. Insert full link including http(s)://', 'mec'); ?>
                                <a href="https://webnus.net/dox/modern-events-calendar/add-event/#Links" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a>
                            </p>
                        </div>
					</div>
					<i title="" class="dashicons-before dashicons-editor-help"></i>
    ...
    ?>
        <div class="mec-add-booking-tabs-wrap">
            <div class="mec-add-booking-tabs-left">
                <a class="mec-add-booking-tabs-link mec-tab-active" data-href="mec_meta_box_booking_options" href="#"><?php echo esc_html__('Booking Options','mec'); ?></a>
    ...
    public function save_event($post_id)
    {
        ...
        // Date Options
        $date = isset($_mec['date']) ? $_mec['date'] : [];
        ...
        $raw_hourly_schedules = isset($_mec['hourly_schedules']) ? $_mec['hourly_schedules'] : [];
    ...
    public function filter_columns($columns)
    {
        ...
        // Sold Tickets
        if($this->getPRO() and (isset($this->settings['booking_status']) and $this->settings['booking_status'])) $columns['sold_tickets'] = esc_html__('Sold Tickets', 'mec');
    ...
    public function action_links($actions, $post)
    {
        ...
        {
            // Duplicate Button
            $actions['mec-duplicate'] = '<a href="'.esc_url($this->main->add_qs_vars(array('mec-action'=>'duplicate-event', 'id'=>$post->ID))).'">'.esc_html__('Duplicate', 'mec').'</a>';
        }

        // Booking Button
        if($this->getPRO() && current_user_can('edit_others_posts') && isset($this->settings['booking_status']) && $this->settings['booking_status']) $actions['mec-bookings'] = '<a href="'.esc_url($this->main->add_qs_vars(array('post_type'=>$this->main->get_book_post_type(), 'mec_event_id'=>$post->ID), trim($this->main->URL('admin'), '/ ').'/edit.php')).'">'.esc_html__('Bookings', 'mec').'</a>';
    ...
    public function gallery_image_upload()
    {
        ...
        // No file
        if(!count($images)) $this->main->response(array('success'=>0, 'code'=>'NO_FILE', 'message'=>esc_html__('Please upload an image.', 'mec')));
