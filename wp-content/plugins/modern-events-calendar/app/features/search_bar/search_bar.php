...
if(isset($settings['search_bar_ajax_mode']) && $settings['search_bar_ajax_mode'] == '1')
{
    ...
    <div class="mec-ajax-search-result">
        <div class="mec-text-input-search">
            ...
            <input type="text" placeholder="'.esc_html__('Please enter at least 3 characters' , 'mec').'" value="" id="keyword" name="keyword" />
        </div>
        <div id="mec-ajax-search-result-wrap"><div class="mec-ajax-search-result-events">'.esc_html__('Search results will show here' ,'mec').'</div></div>
    </div>';
}
else
{
