                ...
                <div class="mec-container">
                    ...
                    <form id="mec_booking_form">
                                    ...
                                    <div class="mec-col-9">
                                        ...
                                        <span class="mec-tooltip">
                                            <div class="box left">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("If the author has not selected a specific category for the recorded event using frontend event submission form, MEC will assigne this category to it by default.", 'mec'); ?></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                    </div>
                        ...
                        <div id="fes_acl_options" class="mec-options-fields">
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Access Level', 'mec'); ?></h5>
                        ...
                        <h5 class="mec-form-subtitle"><?php esc_html_e('Frontend Event Submission Sections', 'mec'); ?></h5>
                            ...
                            <div class="mec-form-row">
                                <label>
                                    ...
                                    <input value="1" type="checkbox" name="mec[settings][fes_section_event_gallery]" <?php if(!isset($settings['fes_section_event_gallery']) or (isset($settings['fes_section_event_gallery']) and $settings['fes_section_event_gallery'])) echo 'checked="checked"'; ?> /><?php esc_html_e('Event Gallery', 'mec'); ?>
                                </label>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="mec-form-row">
                                <label>
                                    ...
                                    <input value="1" type="checkbox" name="mec[settings][fes_section_related_events]" <?php if(!isset($settings['fes_section_related_events']) or (isset($settings['fes_section_related_events']) and $settings['fes_section_related_events'])) echo 'checked="checked"'; ?> /><?php esc_html_e('Related Events', 'mec'); ?>
                                </label>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="mec-form-row">
                                <label>
                                    ...
                                    <input value="1" type="checkbox" name="mec[settings][fes_section_banner]" <?php if(!isset($settings['fes_section_banner']) or (isset($settings['fes_section_banner']) and $settings['fes_section_banner'])) echo 'checked="checked"'; ?> /><?php esc_html_e('Event Banner', 'mec'); ?>
                                </label>
                            </div>
                            <?php endif; ?>
                                    ...
                                    <div class="mec-col-9">
                                        ...
                                        <span class="mec-tooltip">
                                            <div class="box left">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("Users are able to see the list of ogranizers and use them for their event. Set it to \"No\" if you want to disable this functionality and the \"Other Organizers\" feature.", 'mec'); ?></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                    </div>
                            ...
                            <div class="mec-form-row">
                                <label>
                                    ...
                                    <input value="1" type="checkbox" name="mec[settings][fes_section_sponsor]" <?php if(isset($settings['fes_section_sponsor']) and $settings['fes_section_sponsor']) echo 'checked="checked"'; ?> /><?php esc_html_e('Sponsors', 'mec'); ?>
                                </label>
                            </div>
                            <div class="mec-form-row">
                                <label>
