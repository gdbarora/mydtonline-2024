                                    ...
                                    <div class="mec-col-9">
                                        ...
                                        <span class="mec-tooltip">
                                            <div class="box left">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("Enabaling this option will display the breadcrumbs on the single event page", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/single-event-settings/#3-_Breadcrumbs/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                    </div>
                                    ...
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            <label>
                                                ...
                                                <input type="checkbox" name="mec[settings][breadcrumbs_category]" id="mec_settings_breadcrumbs_category" <?php echo ((!isset($settings['breadcrumbs_category']) or (isset($settings['breadcrumbs_category']) and $settings['breadcrumbs_category'])) ? 'checked="checked"' : ''); ?> value="1" /><?php esc_html_e('Include Category in Breadcrumbs.', 'mec'); ?>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mec-form-row">
                                        <label>
                                            ...
                                            <input value="1" type="checkbox" name="mec[settings][banner_status]" <?php if(isset($settings['banner_status']) and $settings['banner_status']) echo 'checked="checked"'; ?> /><?php esc_html_e('Enable Event Banner Feature', 'mec'); ?>
                                        </label>
                                    </div>
                                </div>
