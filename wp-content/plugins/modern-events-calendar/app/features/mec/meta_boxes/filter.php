        ...
        <div class="mec-create-shortcode-tabs-wrap">
            ...
            <div class="mec-add-booking-tabs-right">
                <div class="mec-form-row mec-create-shortcode-tab-content mec-tab-active" id="mec_select_categories">
                    ...
                    <p style="line-height: normal; margin-bottom: 0;" class="description"><?php esc_html_e('Choose your desired categories for filtering the events.', 'mec'); ?></p>
                    ...
                    <p style="line-height: normal; margin-bottom: 0;" class="description"><?php esc_html_e('Choose your desired categories to exclude from the results.', 'mec'); ?></p>
                    <p class="description" style="color: red;"><?php esc_html_e('You will see only those categories that are associated to at-least one event.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_locations">
                    ...
                    <h4 style="margin-bottom: 10px;"><?php echo esc_html__('Include', 'mec'); ?></h4>
                    <p style="line-height: normal; margin-bottom: 0;" class="description"><?php esc_html_e('Choose your desired locations for filtering the events.', 'mec'); ?></p>
                    ...
                    <h4 style="margin-top: 50px; margin-bottom: 10px;"><?php echo esc_html__('Exclude', 'mec'); ?></h4>
                    <p style="line-height: normal; margin-bottom: 0;" class="description"><?php esc_html_e('Choose your desired locations to exclude from the results.', 'mec'); ?></p>
                    <p class="description" style="color: red;"><?php esc_html_e('You will see only those locations that are associated to at-least one event.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_organizers">
                    ...
                    <h4 style="margin-bottom: 10px;"><?php echo esc_html__('Include', 'mec'); ?></h4>
                    <p style="line-height: normal; margin-bottom: 0;" class="description"><?php esc_html_e('Choose your desired organizers for filtering the events.', 'mec'); ?></p>
                    ...
                    <h4 style="margin-top: 50px; margin-bottom: 10px;"><?php echo esc_html__('Exclude', 'mec'); ?></h4>
                    <p style="line-height: normal; margin-bottom: 0;" class="description"><?php esc_html_e('Choose your desired organizers to exclude from the results.', 'mec'); ?></p>
                    <p class="description" style="color: red;"><?php esc_html_e('You will see only those organizers that are associated to at-least one event.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_sponsors">
                    ...
                    <p style="line-height: normal; margin-bottom: 0;" class="description"><?php esc_html_e('Choose your desired sponsors for filtering the events.', 'mec'); ?></p>
                ...
                <div class="mec-form-row mec-create-shortcode-tab-content" id="mec_select_tags">
                    ...
                    <input type="text" name="mec_tax_input[mec_tag]" value="<?php echo esc_attr($selected_tags); ?>"
                           class="widefat" title="<?php echo esc_attr__('Tags', 'mec'); ?>" />
                </div>
