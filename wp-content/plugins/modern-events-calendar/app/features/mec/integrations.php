                                        ...
                                        <div class="mec-col-9">
                                            ...
                                            <span class="mec-tooltip">
                                                <div class="box left">
                                                    ...
                                                    <div class="content"><p><?php esc_attr_e("First, you need to enter the API Key and the Access Token so that your Constant Contact lists appear under this option.", 'mec'); ?></p></div>
                                                </div>
                                                <i title="" class="dashicons-before dashicons-editor-help"></i>
                                            </span>
                                        </div>
