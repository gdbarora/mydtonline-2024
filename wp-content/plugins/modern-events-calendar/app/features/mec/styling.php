                ...
                <div class="mec-container">
                    <form id="mec_styling_form">
                        <div class="mec-options-fields">
                            <h2><?php esc_html_e('Styling', 'mec'); ?></h2>
                        <!-- Colorskin -->
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_styling_dark_mode"><?php esc_html_e('Dark Mode', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    <label id="mec_styling_dark_mode" >                                                
                                        <input type="hidden" name="mec[styling][dark_mode]" value="0" />
                                        <input value="1" type="checkbox" id="mec_styling_dark_mode" name="mec[styling][dark_mode]" <?php if(isset($styling['dark_mode']) and $styling['dark_mode']) echo 'checked="checked"'; ?> /><?php esc_html_e('Enable', 'mec'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box top">
                                            <h5 class="title"><?php esc_html_e('Dark Mode', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('Enable this option to turn on the dark mode', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/appearance-settings/#3-_Dark_Mode/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <label><?php esc_html_e('Title', 'mec' ); ?></label>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <label><?php esc_html_e('Title Hover', 'mec' ); ?></label>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <label><?php esc_html_e('Content', 'mec' ); ?></label>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_h_fontfamily"><?php esc_html_e('Heading (Events Title) Font Family', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    ...
                                    <select class="mec-p-fontfamily" name="mec[styling][mec_h_fontfamily]" id="mec_h_fontfamily">
                                        ...
                                        foreach($google_fonts as $google_font)
                                        {
                                            ...
                                            if($value == '['.esc_html__('Default Font', 'mec').',regular]') $value = '';
                                            ?>
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_p_fontfamily"><?php esc_html_e('Paragraph Font Family', 'mec'); ?></label>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_styling_disable_gfonts"><?php esc_html_e('Disable Google Fonts', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    <label id="mec_styling_disable_gfonts">
                                        <input type="hidden" name="mec[styling][disable_gfonts]" value="0" />
                                        <input value="1" type="checkbox" id="mec_styling_disable_gfonts" name="mec[styling][disable_gfonts]" <?php if(isset($styling['disable_gfonts']) and $styling['disable_gfonts']) echo 'checked="checked"'; ?> /><?php esc_html_e('Disable', 'mec'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box top">
                                            <h5 class="title"><?php esc_html_e('Disable Google Fonts', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('To be GDPR compliant you may need to disable Google fonts. Set "Default Font" value for font family and enable this option.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/appearance-settings/#9-_Disable_Google_Fonts/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <!-- Container Width -->
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Accessibility', 'mec' ); ?></h5>
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_styling_accessibility"><?php esc_html_e('Accessibility', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    <label id="mec_styling_accessibility">                                                
                                        <input type="hidden" name="mec[styling][accessibility]" value="0" />
                                        <input value="1" type="checkbox" id="mec_styling_accessibility" name="mec[styling][accessibility]" <?php if(isset($styling['accessibility']) and $styling['accessibility']) echo 'checked="checked"'; ?> /><?php esc_html_e('Enable', 'mec'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box top">
                                            <h5 class="title"><?php esc_html_e('Accessibility', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('Enable A11Y or accessibility in MEC.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/improving-accessibility-on-mec/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_styling_container_normal_width"><?php esc_html_e('Desktop Normal Screens', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            <h5 class="title"><?php esc_html_e('Desktop Normal Screens', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('You can enter your theme container size in this field to override it for normal screens.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/appearance-settings/#11-_Desktop_Normal_Screens/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_styling_container_large_width"><?php esc_html_e('Desktop Large Screens', 'mec'); ?></label>
                                <div class="mec-col-9">
                                    ...
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            <h5 class="title"><?php esc_html_e('Desktop Large Screens', 'mec'); ?></h5>
                                            <div class="content"><p><?php esc_attr_e('You can enter your theme container size in this field to override it for large screens.', 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/appearance-settings/#12-_Desktop_Large_Screens/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                        </div>
                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                    </span>
                                </div>
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <label><?php esc_html_e('Frontend Event Submission Color', 'mec' ); ?></label>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                <div class="mec-col-3">
                                    <label><?php esc_html_e('Notifications Background', 'mec' ); ?></label>
                                </div>
                                <div class="mec-col-9">
                            ...
                            <div class="mec-form-row">
                                ...
                                <button  style="display: none;" id="mec_styling_form_button" class="button button-primary mec-button-primary" type="submit"><?php esc_html_e('Save Changes', 'mec'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
