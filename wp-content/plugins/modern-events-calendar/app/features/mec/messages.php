                ...
                <div class="mec-container">
                    <form id="mec_messages_form">
                        <div class="mec-options-fields active">
                            <h2><?php esc_html_e('Messages', 'mec'); ?></h2>
                            <p><?php esc_html_e("You can change some MEC messages here. For example if you like to change \"REGISTER\" button label, you can do it here. By the Way, if your website is a multilingual website, we recommend you to change the messages/phrases from language files.", 'mec'); ?></p>
                            ...
                            <div class="mec-form-row">
                                ...
                                <?php endif; ?>
                                <button style="display: none;" id="mec_messages_form_button" class="button button-primary mec-button-primary" type="submit"><?php esc_html_e('Save Changes', 'mec'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
