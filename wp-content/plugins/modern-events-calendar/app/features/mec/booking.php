                ...
                <div class="mec-container">
                    ...
                    <form id="mec_booking_form">
                                    ...
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            <select id="mec_settings_booking_date_selection_per_event" name="mec[settings][booking_date_selection_per_event]">
                                                <option value="0" <?php echo ((!isset($settings['booking_date_selection_per_event']) or (isset($settings['booking_date_selection_per_event']) and $settings['booking_date_selection_per_event'] == 0)) ? 'selected' : ''); ?>><?php esc_html_e('No', 'mec'); ?></option>
                                                <option value="1" <?php echo ((isset($settings['booking_date_selection_per_event']) and $settings['booking_date_selection_per_event'] == 1) ? 'selected' : ''); ?>><?php esc_html_e('Yes', 'mec'); ?></option>
                                            </select>
                                            <span class="mec-tooltip">
                                            <div class="box left">
                        ...
                        <div id="booking_elements" class="mec-options-fields">
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Booking Elements', 'mec'); ?></h5>
                            <div class="mec-form-row">
                                <div class="mec-col-12">
                        ...
                        <div id="booking_tickets_option" class="mec-options-fields">
                            <h5 class="mec-form-subtitle"><?php esc_html_e('Global Tickets', 'mec'); ?></h5>
                            <div class="mec-form-row">
                            ...
                            <div id="mec_coupons_container_toggle" class="<?php if((isset($settings['coupons_status']) and !$settings['coupons_status']) or !isset($settings['coupons_status'])) echo 'mec-util-hidden'; ?>">
                                <div class="mec-form-row">
                                    <label>
                                        ...
                                        <input value="1" type="checkbox" name="mec[settings][coupons_apply_100percent_to_all]" <?php if(isset($settings['coupons_apply_100percent_to_all']) and $settings['coupons_apply_100percent_to_all']) echo 'checked="checked"'; ?> /><?php esc_html_e('Apply 100 percent coupons to all fees', 'mec'); ?>
                                    </label>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div id="mec_taxes_fees_container_toggle" class="<?php if((isset($settings['taxes_fees_status']) and !$settings['taxes_fees_status']) or !isset($settings['taxes_fees_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-form-row" id="mec_fees_list">
                                    ...
                                    <div class="mec-box" id="mec_fee_row<?php echo esc_attr($i); ?>">
                                        <div class="mec-form-row">
                                            <input class="mec-col-12" type="text" name="mec[settings][fees][<?php echo esc_attr($i); ?>][title]" placeholder="<?php esc_attr_e('Fee Title', 'mec'); ?>" value="<?php echo (isset($fee['title']) ? esc_attr($fee['title']) : ''); ?>" />
                                        </div>
                                        <div class="mec-form-row">
                                            <span class="mec-col-4">
                                                <input type="text" name="mec[settings][fees][<?php echo esc_attr($i); ?>][amount]" placeholder="<?php esc_attr_e('Amount', 'mec'); ?>" value="<?php echo (isset($fee['amount']) ? esc_attr($fee['amount']) : 0); ?>" />
                                                <span class="mec-tooltip">
                                                    <div class="box top">
                                            ...
                                            <button class="button" type="button" id="mec_remove_fee_button<?php echo esc_attr($i); ?>" onclick="mec_remove_fee(<?php echo esc_attr($i); ?>);"><?php esc_html_e('Remove', 'mec'); ?></button>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
                                ...
                                <div class="mec-util-hidden" id="mec_new_fee_raw">
                                    <div class="mec-box" id="mec_fee_row:i:">
                                        ...
                                        <div class="mec-form-row">
                                            ...
                                            <button class="button" type="button" id="mec_remove_fee_button:i:" onclick="mec_remove_fee(:i:);"><?php esc_html_e('Remove', 'mec'); ?></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mec-form-row">
                                    <h4><?php echo esc_html__('Disable Fees per Gateways', 'mec'); ?></h4>
                                    ...
                                    <div class="mec-form-row" id="mec_ticket_variations_list">
                                        <?php $i = 0; foreach($ticket_variations as $key=>$ticket_variation): if(!is_numeric($key)) continue; $i = max($i, $key); ?>
                                            <div class="mec-box mec_ticket_variation_row" id="mec_ticket_variation_row<?php echo esc_attr($i); ?>">
                                                <div class="mec-form-row">
                                                    <input class="mec-col-12" type="text" name="mec[settings][ticket_variations][<?php echo esc_attr($i); ?>][title]" placeholder="<?php esc_attr_e('Title', 'mec'); ?>" value="<?php echo (isset($ticket_variation['title']) ? esc_attr($ticket_variation['title']) : ''); ?>" />
                                                </div>
                                                <div class="mec-form-row">
                                                    <span class="mec-col-4">
                                                        <input type="text" name="mec[settings][ticket_variations][<?php echo esc_attr($i); ?>][price]" placeholder="<?php esc_attr_e('Price', 'mec'); ?>" value="<?php echo (isset($ticket_variation['price']) ? esc_attr($ticket_variation['price']) : ''); ?>" />
                                                        <span class="mec-tooltip">
                                                            <div class="box top">
                                                                <h5 class="title"><?php esc_html_e('Price', 'mec'); ?></h5>
                                                                <div class="content"><p><?php esc_attr_e("Option Price", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#Ticket_Variations_per_Ticket/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                                            </div>
                                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                                        </span>
                                                    </span>
                                                    <span class="mec-col-4">
                                                        <input type="number" min="0" name="mec[settings][ticket_variations][<?php echo esc_attr($i); ?>][max]" placeholder="<?php esc_attr_e('Maximum Per Ticket', 'mec'); ?>" value="<?php echo (isset($ticket_variation['max']) ? esc_attr($ticket_variation['max']) : ''); ?>" />
                                                        <span class="mec-tooltip">
                                                            <div class="box top">
                                                                <h5 class="title"><?php esc_html_e('Maximum Per Ticket', 'mec'); ?></h5>
                                                                <div class="content"><p><?php esc_attr_e("Maximum Per Ticket. Leave blank for unlimited.", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#Ticket_Variations_per_Ticket/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                                            </div>
                                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                                        </span>
                                                    </span>
                                                    <button class="button mec_remove_ticket_variation_button mec-dash-remove-btn" type="button" id="mec_remove_ticket_variation_button<?php echo esc_attr($i); ?>" onclick="mec_remove_ticket_variation(<?php echo esc_attr($i); ?>, 'ticket_variation');"><?php esc_html_e('Remove', 'mec'); ?></button>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                            ...
                                            <div class="mec-form-row">
                                                <span class="mec-col-4">
                                                    ...
                                                    <span class="mec-tooltip">
                                                        <div class="box top">
                                                            <h5 class="title"><?php esc_html_e('Price', 'mec'); ?></h5>
                                                            <div class="content"><p><?php esc_attr_e("Option Price", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/ticket-variations/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                                        </div>
                                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                                    </span>
                                                </span>
                                                <span class="mec-col-4">
                                                    ...
                                                    <span class="mec-tooltip">
                                                        <div class="box top">
                                                            <h5 class="title"><?php esc_html_e('Maximum Per Ticket', 'mec'); ?></h5>
                                                            <div class="content"><p><?php esc_attr_e("Maximum Per Ticket. Leave blank for unlimited.", 'mec'); ?><a href="https://webnus.net/dox/modern-events-calendar/ticket-variations/" target="_blank"><?php esc_html_e('Read More', 'mec'); ?></a></p></div>
                                                        </div>
                                                        <i title="" class="dashicons-before dashicons-editor-help"></i>
                                                    </span>
                                                </span>
                                                <button class="button mec_remove_ticket_variation_button mec-dash-remove-btn" type="button" id="mec_remove_ticket_variation_button:i:" onclick="mec_remove_ticket_variation(:i:, 'ticket_variation');"><?php esc_html_e('Remove', 'mec'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
