    ...
    public function contextual( $contextual_help, $screen_id)
    {
        ...
        switch($screen_id)
        {
            case 'm-e-calendar_page_MEC-settings':
                ...
                (
                    'id' => 'mec-form',
                    'title' => esc_html__('Booking Form', 'mec'),
                    'content' => esc_html__('<h2 class="dark-text">Booking Form<hr></h2>
                        <strong>Build your booking registration form (This form will be used for every attendee).</strong>                   <iframe width="600" height="300" src="https://www.youtube.com/embed/YM8cCOvgpk0" frameborder="0" allowfullscreen></iframe>', 'mec')
                ));

                $screen->add_help_tab(array
                (
                    'id' => 'mec-gateways',
                    'title' => esc_html__('Payment Gateways', 'mec'),
                    'content' => esc_html__('<h2 class="dark-text">Payment Gateways <hr></h2><iframe width="600" height="300" src="https://www.youtube.com/embed/Hpg4chWlxoQ" frameborder="0" allowfullscreen></iframe>', 'mec')
                ));

                $screen->add_help_tab(array
                (
                    'id' => 'mec-notifications',
                    'title' => esc_html__('Notifications', 'mec'),
                    'content' => esc_html__('<h2 class="dark-text">Notifications <hr></h2><strong>You can edit your messages in there.</strong><strong>MEC Notificatoin Module</strong><iframe width="600" height="300" src="https://www.youtube.com/embed/ZAA8zVewOj0" frameborder="0" allowfullscreen></iframe>', 'mec')
                ));
            ...
            case 'm-e-calendar_page_MEC-ix':
                ...
                (
                    'id' => 'mec-importexport',
                    'title' => esc_html__('Google Cal. Import', 'mec'),
                    'content' => esc_html__('<h2 class="dark-text">Import/Export<hr></h2><div class="big-title2"><strong>Google Cal. Import:</strong></div><iframe width="854" height="420" src="https://www.youtube.com/embed/vxHC7NVbmuc" frameborder="0" allowfullscreen></iframe>', 'mec')
                ));

                $screen->add_help_tab(array
                (
                    'id' => 'mec-importexportg',
                    'title' => esc_html__('Google Cal. Export', 'mec'),
                    'content' => esc_html__('<h2 class="dark-text">Import/Export<hr></h2><div class="big-title2"><strong>Google Cal. Export:</strong></div><iframe width="854" height="420" src="https://www.youtube.com/embed/DdeNazxbLyo" frameborder="0" allowfullscreen></iframe>', 'mec')
                ));

                $screen->add_help_tab(array
                (
                    'id' => 'mec-importexportf',
                    'title' => esc_html__('Facebook Cal. Import', 'mec'),
                    'content' => esc_html__('<h2 class="dark-text">Import/Export<hr></h2><div class="big-title2"><strong>Facebook Cal. Import:</strong></div><iframe width="854" height="420" src="https://www.youtube.com/embed/dqgt1b8X8hs" frameborder="0" allowfullscreen></iframe>', 'mec')
                ));
    ...
    public function settings()
    {
        ...
        <div class="mec-form-row" id="mec_setting_contextual">
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="genral_setting" data-status="close"><?php esc_html_e('General Options','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="slugs" data-status="close"><?php esc_html_e('Slugs/Permalinks','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="event_detail" data-status="close"><?php esc_html_e('Event Details/Single Event Page','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="currency" data-status="close"><?php esc_html_e('Currency Options','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="g_map" data-status="close"><?php esc_html_e('Google Maps Options','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="g_recaptcha" data-status="close"><?php esc_html_e('Google Recaptcha Options','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="countdown" data-status="close"><?php esc_html_e('Countdown Options','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="social" data-status="close"><?php esc_html_e('Social Networks','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="next_event" data-status="close"><?php esc_html_e('Next Event Module','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="fes" data-status="close"><?php esc_html_e('Frontend Event Submission','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="exceptional" data-status="close"><?php esc_html_e('Exceptional Days','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="booking" data-status="close"><?php esc_html_e('Booking','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="coupon" data-status="close"><?php esc_html_e('Coupons','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="buddy" data-status="close"><?php esc_html_e('BuddyPress Integration','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="mailchimp" data-status="close"><?php esc_html_e('Mailchimp Integration','mec'); ?></li>
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="activation" data-status="close"><?php esc_html_e('MEC Activation','mec'); ?></li>
