...
class MEC_feature_locations extends MEC_base
{
    ...
    {
        $singular_label = $this->main->m('taxonomy_location', esc_html__('Location', 'mec'));
        $plural_label = $this->main->m('taxonomy_locations', esc_html__('Locations', 'mec'));
    ...
    ?>
        <tr class="form-field">
            <th scope="row">
                <label for="mec_address"><?php esc_html_e('Address', 'mec'); ?></label>
            </th>
            <td>
                <input class="mec-has-tip" type="text" placeholder="<?php esc_attr_e('Enter the location address', 'mec'); ?>" name="address" id="mec_address" value="<?php echo esc_attr($address); ?>" />
        ...
        <tr class="form-field">
            <th scope="row">
                <label for="mec_opening_hour"><?php esc_html_e('Opening Hour', 'mec'); ?></label>
            </th>
            <td>
                <input type="text" placeholder="<?php esc_attr_e('Opening hour in text format like 09:15 or 18:30', 'mec'); ?>" name="opening_hour" id="mec_opening_hour" value="<?php echo esc_attr($opening_hour); ?>" />
            </td>
        </tr>
        <tr class="form-field">
            <th scope="row">
                <label for="mec_latitude"><?php esc_html_e('Latitude', 'mec'); ?></label>
            </th>
            <td>
                <input class="mec-has-tip" type="text" placeholder="<?php esc_attr_e('Geo latitude (Optional for Lite)', 'mec'); ?>" name="latitude" id="mec_latitude" value="<?php echo esc_attr($latitude); ?>" />
            </td>
        </tr>
        <tr class="form-field">
            <th scope="row">
                <label for="mec_longitude"><?php esc_html_e('Longitude', 'mec'); ?></label>
            </th>
            <td>
                <input class="mec-has-tip" type="text" placeholder="<?php esc_attr_e('Geo longitude (Optional for Lite)', 'mec'); ?>" name="longitude" id="mec_longitude" value="<?php echo esc_attr($longitude); ?>" />
            </td>
        </tr>
        <tr class="form-field">
            <th scope="row">
                <label for="mec_url"><?php esc_html_e('Location Website', 'mec'); ?></label>
            </th>
            <td>
                <input type="url" placeholder="<?php esc_attr_e('Location Website (Optional)', 'mec'); ?>" name="url" id="mec_url" value="<?php echo esc_attr($url); ?>" />
            </td>
        </tr>
    ...
    ?>
        ...
        <div class="form-field">
            <label for="mec_opening_hour"><?php esc_html_e('Opening Hour', 'mec'); ?></label>
            <input type="text" placeholder="<?php esc_attr_e('Opening hour in text format like 09:15 or 18:30', 'mec'); ?>" name="opening_hour" id="mec_opening_hour" value="" />
        </div>
        <div class="form-field">
            <label for="mec_latitude"><?php esc_html_e('Latitude', 'mec'); ?></label>
    ...
    public function filter_columns($columns)
    {
        ...
        $columns['name'] = esc_html__('Location', 'mec');
    ...
    public function save_event($post_id)
    {
        ...
        $name = (isset($_mec['location']['name']) and trim($_mec['location']['name'])) ? sanitize_text_field($_mec['location']['name']) : (trim($address) ? $address : esc_html__('Location Name', 'mec'));
