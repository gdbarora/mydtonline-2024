...
//        add_filter('fluentform_notifying_async_mailjet', '__return_false');
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_wp_error($response)) {
            do_action('ff_integration_action_result', $feed, 'success', 'Mailjet feed has been successfully initiated and pushed data');
        } else {
