...
class Uploader extends BaseComponent
{
	...
	public function compile($data, $form)
	{
        ...
        $elMarkup = "<label for='".$data['attributes']['id']."' class='ff_file_upload_holder'><span class='ff_upload_btn ff-btn'>".$btnText."</span> <input %s aria-invalid='false' aria-required={$ariaRequired}></label>";
