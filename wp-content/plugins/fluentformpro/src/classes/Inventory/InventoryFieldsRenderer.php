...
class InventoryFieldsRenderer
{
    ...
    public function processInventoryFields($field, $form, $previousSubmissionData)
    {
        ...
        return apply_filters('fluentform_inventory_fields_before_render', $field, $form, $previousSubmissionData);
    }
    ...
    public static function getInventoryFields($form, $type = 'simple' )
    {
        ...
        $inventoryFields = FormFieldsParser::getElement($form, $inventoryAllowedInputs, ['element', 'attributes', 'settings']);
    ...
    public function processBeforeFormRender()
    {
        ...
        add_filter('fluentform_rendering_form', function ($form) use ($previousSubmissionCache) {
            ...
            foreach ($inventoryFields as $inventoryField) {
                ...
                add_filter('fluentform_rendering_field_data_' . $element,
