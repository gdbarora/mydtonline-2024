 ...
 * Image Type
 */
class Field_Type_Profile_Image extends \BP_XProfile_Field_Type
{
	...
	public function __construct()
	{
		...
		$this->name     = _x('Profile Image', 'xprofile field type', 'bp-xprofile-custom-field-types');
		$this->category = _x('Custom Fields', 'xprofile field type category', 'bp-xprofile-custom-field-types');

		$this->set_format('/^.+$/', 'replace');
		do_action('bp_xprofile_field_type_profile_image', $this);
	}
...
?>
		...
		<div class="profileimage_status" data-profileimage="status">
		...
		<input type="hidden" value="<?php echo esc_attr($edit_value); ?>" name="<?php echo esc_attr($name); ?>" data-fieldtype="profileimage" />
