...
<div class="bb-dropdown-wrap">
	<div class="location-album-list-wrap-main <?php echo wp_is_mobile() ? 'is-mobile' : ''; ?>">
		<span class="no-album-exists" style="display: none;"><?php esc_html_e( 'You have not created any album yet to move this video into.', 'buddyboss' ); ?></span>
		...
		<div class="location-album-list-wrap">
			...
			<input type="hidden" id="current-folder-id">
			<input type="hidden" id="selected-video-id">
