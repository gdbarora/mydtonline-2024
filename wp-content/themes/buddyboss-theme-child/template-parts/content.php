...
$bb_user_subbmited = get_post_meta($post->ID, 'bb_user_subbmited', true);

$className = ($bb_user_subbmited) ? 'bb_announcements bb_user_submmitted' : (($post->post_type == 'announcements') ? 'announcements-content' : 'article-content');
?>
